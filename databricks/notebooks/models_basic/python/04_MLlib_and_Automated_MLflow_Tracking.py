...
# MAGIC %md # MLlib + Automated MLflow Tracking
# MAGIC 
# MAGIC This notebook demonstrates how to use automated MLflow tracking to track MLlib model tuning. 
# MAGIC 
# MAGIC Based upon:
# MAGIC * [Hyperparameter Tuning with MLflow, Apache Spark MLlib and Hyperopt](https://databricks.com/blog/2019/06/07/hyperparameter-tuning-with-mlflow-apache-spark-mllib-and-hyperopt.html) - blog post - 2019-06-07
# MAGIC * Accompanying notebook: https://docs.databricks.com/_static/notebooks/mllib-mlflow-integration.html
# MAGIC 
